...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://wa.me/+923377519518"])
...
def notice():
	...
	runtxt("\033[0;92m ADMIN WHATSAPP >> +923377519518")
	subprocess.check_output(["am", "start", "https://wa.me/+923377519518"])
...
\x1b[0;91m\x1b[1;43m                  SYC0 TH3 BR4ND :)                 \x1b[0m""")
		...
		print("%s [%sâ¢%s] %sVERSION   : %s0.1"%(G,R,G,B,G))
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [HAADI HERE] : %s/%s -> \033[0;92m [ HAADI-OK:%s ]- \033[0;94m[HAADI-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
